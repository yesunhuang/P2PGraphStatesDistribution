'''
Name: FixedTypeGraphWithRandomNetwork_ND_N_E_05
...
#%% data Path
EXP_NAME='FixedTypeGraphWithRandomNetwork_ND_N_E_05'
...
if __name__=='__main__':
    ...
    vertexGroupNums=np.linspace(20,2*nodes,groupNum,dtype=int)
    graphSeeds=globalRng.integers(0,100000,(groupNum,batchNum,batchSize))
    graphParams=0.2+0.4*globalRng.random((groupNum,batchNum,batchSize))
