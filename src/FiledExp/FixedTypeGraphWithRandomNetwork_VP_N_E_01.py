'''
Name: FixedTypeGraphWithRandomNetwork_VP_N_E_01
...
#%% data Path
EXP_NAME='FixedTypeGraphWithRandomNetwork_VP_N_E_01'
...
if __name__=='__main__':
    ...
    for i in range(0,groupNum):
        ...
        for j in range(0,batchNum):
            ...
            graphStates=task.generate_distribution_task([vertexGroupNums]*batchSize,topology='star')
