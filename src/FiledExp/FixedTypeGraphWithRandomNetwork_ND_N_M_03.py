'''
Name: FixedTypeGraphWithRandomNetwork_ND_N_M_03
...
#%% data Path
EXP_NAME='FixedTypeGraphWithRandomNetwork_ND_N_M_03'
...
if __name__=='__main__':
    ...
    vertexGroupNums=np.linspace(3,int(np.sqrt(2*nodes)),groupNum,dtype=int)
