'''
Name: FixedTypeGraphWithRandomNetwork_TE_N_E_01
...
#%% data Path
EXP_NAME='FixedTypeGraphWithRandomNetwork_TE_N_E_01'
...
if __name__=='__main__':
    ...
    vertexGroupNums=np.linspace(3,int(np.sqrt(4*nodes)),groupNum,dtype=int)
